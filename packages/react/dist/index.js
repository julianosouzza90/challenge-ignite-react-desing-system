...
var Content2 = styled(TooltipRadix.Content, {
  padding: "$3 $4",
  backgroundColor: "$gray900",
  borderRadius: "$xs",
  color: "$gray100",
...
var Arrow2 = styled(TooltipRadix.Arrow, {
  fill: "$gray900"
});
...
function Tooltip(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TooltipRadix2.Provider, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(TooltipRadix2.Root, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TooltipRadix2.Trigger, { asChild: true, children }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TooltipRadix2.Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Content2, { children: [
      content,
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Arrow2, {})
    ] }) })
  ] }) });
}

// src/components/Toast/index.tsx
var ToastRadix2 = __toESM(require("@radix-ui/react-toast"));
var import_phosphor_react3 = require("phosphor-react");

// src/components/Toast/styles.ts
var ToastRadix = __toESM(require("@radix-ui/react-toast"));
var Root5 = styled(ToastRadix.Root, {
  display: "flex",
...
var CloseButton = styled(ToastRadix.Close, {
  all: "unset",
  position: "absolute",
  right: 0,
  top: 0,
...
var Title2 = styled(ToastRadix.Title, {
  color: "$white",
  fontFamily: "$default",
  fontWeight: "$bold",
  fontSize: "$xl",
...
var Description2 = styled(ToastRadix.Description, {
  fontFamily: "$default",
  fontWeight: "$medium",
  fontSize: "$sm",
  lineHeight: "$base",
...
function Toast(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(ToastRadix2.Provider, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(Root5, { duration: 1e5, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Title2, { children: title }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Description2, { children: description }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ToastRadix2.Action, { altText: "" }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(CloseButton, { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_phosphor_react3.X, {}) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ToastRadix2.Viewport, {})
  ] });
}
